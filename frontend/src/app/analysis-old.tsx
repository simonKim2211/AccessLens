  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-white">
      ...
      <main id="main-content" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <div className="bg-white p-6 rounded-lg shadow-sm border">
              ...
              <p className="text-gray-600 text-sm">
                Generate screenshots showing your site through the eyes of users with color blindness, 
                low vision, cataracts, glaucoma, and other visual impairments
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm border">
        ...
        {/* Visual Impairment Simulation Section */}
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-blue-700 text-sm">
                See how your website appears to users with different visual impairments including color blindness, 
                low vision, cataracts, and more. Generate detailed screenshots with accessibility insights.
              </p>
            </div>
            <button
              onClick={() => setShowVisionSimulator(true)}
              disabled={!url}
              className="bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 text-white px-6 py-3 rounded-lg font-semibold transition-colors flex items-center gap-2 ml-4"
            >
              <Eye className="h-5 w-5" />
              Generate Vision Test
            </button>
          </div>
        </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <div className="flex gap-2 sm:gap-4">
                <button
                  ...
                  className="flex-1 sm:flex-none bg-red-600 hover:bg-red-700 disabled:bg-gray-400 text-white px-6 sm:px-8 py-3 rounded-lg font-semibold transition-colors flex items-center justify-center gap-2"
                >
                  {isAnalyzing ? (
                    <>
                ...
                <button
                  onClick={() => setShowVisionSimulator(true)}
                  disabled={!url}
                  className="flex-1 sm:flex-none bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 text-white px-4 sm:px-6 py-3 rounded-lg font-semibold transition-colors flex items-center justify-center gap-2"
                >
                  <Eye className="h-5 w-5" />
                  <span className="hidden sm:inline">Vision Test</span>
              ...
              <div className="bg-white rounded-lg shadow-lg p-8 mt-8">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                  <p className="text-blue-800 text-sm flex items-center gap-2">
                    ...
                    <strong>Need more detailed vision testing?</strong> Use the "Vision Test" button above for comprehensive visual impairment simulations.
                  </p>
                </div>
